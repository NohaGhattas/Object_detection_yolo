...
tracker = Sort(max_age=20, min_hits=3, iou_threshold=0.3)  # Create a tracker object
...
while True:
    ...
    imgGraphics1 =cv2.imread("graphics1.png" , cv2.IMREAD_UNCHANGED)
    img=cvzone.overlayPNG(img,imgGraphics1,(730 , 260))
